...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(hasPermissions()) {
            ...
            NeoConnectButton.setOnClickListener(new View.OnClickListener() {
    ...
    private final BroadcastReceiver ConnectionStateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            Boolean connected_state = (Boolean) intent.getSerializableExtra("connected_state");
    ...
    private final BroadcastReceiver CLIReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            String notification_value = (String) intent.getSerializableExtra("notification_value");
